...
**Projekt:** AI-Freelancer-Plattform → AWS Deployment (muster-plattform.de)

**Team:**

- **Max** - Product Owner, Decisions, Prioritäten, Task-Zuweisung, Merge-Freigabe
...
**⚠️ Keine feste Aufgabenverteilung!** Max entscheidet pro Task wer es übernimmt.
...
2. **Arbeit:** Branch anlegen (feat/_, fix/_, chore/_, ci/_, infra/\*), kleine PRs
...
- **Branches:** feat/_, fix/_, chore/_, ci/_, infra/\*
...
- **Reviews:** Cross-Check zwischen Sonnet/Codex, Max entscheidet Merge
...
Max will das AI-Freelancer-Plattform Projekt auf AWS deployen:

- **Domain:** muster-plattform.de
...
- ✅ Behalten: CloudFront (E2EBJUQH6VGZWO), Route 53 (muster-plattform.de), ACM Certificate
...
## Session 3: 2025-12-01, 08:29-08:55 (Codex)

### Kontext

- Claude Code API meldete "image dimensions exceed max allowed size" bei großen Screenshots.
- Ziel: Landing Page entfernen, ohne weitere Screenshots zu erzeugen.

### Was gemacht

- Landing Page zunächst entfernt, danach neue Landing Page aufgebaut (`src/app/page.tsx`) mit Hero, Freelancer-/Unternehmen-Sektionen, Feature- und Preisblöcken plus CTA-Footer; Navigation-Anker zeigen wieder auf Inhalte.
- Keine weiteren Dateien angepasst.

### Status

- Tests nicht ausgeführt (statische Page).
- Next Steps: CTAs/Copy anpassen oder Redirects ergänzen, falls andere Zielpfade gewünscht.

---

**Quick Links:**

- Repository: https://github.com/MaxMustermann/ai-freelancer-plattform
- GitHub Actions: https://github.com/MaxMustermann/ai-freelancer-plattform/actions
