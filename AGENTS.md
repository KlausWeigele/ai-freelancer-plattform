...
Geltungsbereich: Gesamtes Repository. Dieses Dokument beschreibt, wie in diesem Projekt gearbeitet wird und worauf Agents achten müssen. Bei widersprüchlichen Angaben haben direkte Anweisungen von Max Vorrang.
...
- Aufgaben- und Rollenvergabe erfolgt pro Task/Session durch Max.
- Agents (Claude Code, Codex) machen Vorschläge; finale Entscheidung liegt bei Max.
