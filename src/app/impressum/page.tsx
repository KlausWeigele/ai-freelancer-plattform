    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-amber-800 text-sm">
              Dies ist eine Test- und Demonstrationswebseite. Es handelt sich
              um kein kommerzielles Angebot. Siehe{' '}
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <div className="mt-4 space-y-2 text-gray-700">
              <p>
                ...
                <a
                  href="mailto:kontakt@weigele.art"
          ...
          <div className="mt-4 bg-blue-50 border-l-4 border-blue-500 p-4 text-sm">
            <p className="text-blue-900">
              <strong>Hinweis:</strong> Bitte ergänzen Sie Ihre vollständigen
              Kontaktdaten (Straße, Hausnummer, PLZ, Ort, ggf. Telefonnummer).
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">Klaus Weigele (Betreiber)</p>
        </section>
        ...
        */}
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 text-sm mt-2">
            (Da dies eine Test-Webseite ohne kommerzielle Tätigkeit ist, besteht
